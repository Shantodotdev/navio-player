...
export function Switch({
  ...
  return (
    <button
      ...
      className={`w-11 h-6 flex items-center rounded-full p-1 transition-all duration-250 cursor-pointer focus:outline-none focus:ring-1 focus:ring-brand/40 focus:ring-offset-1 focus:ring-offset-[#0e0e12] ${
        checked
